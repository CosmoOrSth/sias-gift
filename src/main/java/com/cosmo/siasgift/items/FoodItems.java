...
public class FoodItems {
        ...
        public static final Item RAW_BACON = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(1).saturationModifier((float) 1 /2).build()));
        ...
        public static final Item RAW_DUCK = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(1).saturationModifier((float) 1 /2).build()));
        public static final Item COOKED_DUCK = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(5).saturationModifier(8).build()));
        ...
        public static void register() {
            ...
            Registry.register(Registries.ITEM, new Identifier("siasgift", "raw_duck"), RAW_DUCK);
            Registry.register(Registries.ITEM, new Identifier("siasgift", "cooked_duck"), COOKED_DUCK);
        }
}
